 ...
 */
var orgAccess = function (requiredRoles) {
    return function (req, _res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var slug, org, membership, isOwner, userRole, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    membership = _a.sent();
                    isOwner = org.owner_id === req.user.user_id;
                    if (!membership && !isOwner) {
                        throw new ApiError_1.ApiError(403, "You are not a member of this organization.");
                    }
                    // Check role if required
                    if (requiredRoles && requiredRoles.length > 0) {
                        userRole = isOwner ? prisma_2.OrgMemberRole.OWNER : membership === null || membership === void 0 ? void 0 : membership.role;
