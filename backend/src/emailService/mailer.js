...
var sendEmail = function (to, subject, text, html) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, transporter.sendMail({
                    from: "\"".concat(env_1.config.smtpFromName, "\" <").concat(env_1.config.smtpUser, ">"),
                    to: to,
                    subject: subject,
                    text: text,
                    html: html,
